          ...
          <div style={{display:'flex',flexFlow:'column', gap:'22px'}}>
                  ...
                  <div style={{display:'flex',flexFlow:'row', justifyContent:'center',color:'#ffff'}}>
                      ...
                      <div onClick={()=>{
                        ...
                        toast("Copied!!");
                        }} style={{cursor:'pointer',padding:'10px',borderBottomRightRadius:'10px',borderTopRightRadius:'10px',backgroundColor:'#146531',display:'flex',justifyContent:'center',alignItems:'center'}}>
