        ...
        <div className={`right_container`}>
            <div className='sub_container'>
                <div style={{display:'flex',justifyContent:'center'}}>
                    <h2 style={{textAlign:'center'}}>This is how EngageBud <br/> looks like in action!</h2>
                </div>
                <form onSubmit={formSubmit} className='flex flex-col' style={{display:'flex',flexFlow:'column', gap:'22px'}}>
                    ...
                    <div style={{display:'flex',flexFlow:'row', gap:'2px',justifyContent:'flex-start'}}>
                        ...
                        <span style={{width:'100%'}}><p>Phone number</p> <input style={{paddingLeft:'5px',borderRadius:'4px'}} type="mobile" onChange={()=>{}} required/></span>
                    </div>
